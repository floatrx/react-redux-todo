...
export class TodoItem extends Component {
  ...
  renderDisplay() {
    return (
      <div
        className={'todo__item' + (this.props.completed ? ' completed' : '')}
        onDoubleClick={this.enterEditing}
      >
        <Checkbox
        ...
        <Button className="todo__edit icon" icon="edit" onClick={this.enterEditing} />
        <Button
  ...
  renderForm() {
    return (
      <form className="todo__edit-form" onSubmit={this.handleSubmit}>
        ...
        />
        <Button className="todo__form-submit" type="submit" icon="save" />
      </form>
    );
  }
  render() {
